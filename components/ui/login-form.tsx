...
export function SmokeyBackground({
  ...
  color = "#FFFFFF", // Default mono white
  className = "",
    ...
    <div className="w-full max-w-sm p-8 space-y-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl transition-all duration-300">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-gray-300">
          {isSignUp ? "Sign up to get started" : "Sign in to continue to ONLYWEBB"}
        </p>
      </div>
      ...
      <form className="space-y-7" onSubmit={handleSubmit}>
        ...
        <div className="relative z-0">
          ...
          <button
            ...
            className="absolute right-0 top-3 text-gray-300 hover:text-white transition-colors cursor-pointer"
