...
export const GalleryView: React.FC<GalleryViewProps> = ({
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-black/40 border border-neutral-800/80 rounded-3xl p-4 sm:p-8 text-white my-4"
    >
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-neutral-800 pb-6">
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-neutral-900 border border-neutral-800 text-neutral-300 hover:text-white hover:bg-neutral-800 hover:border-neutral-700 transition-all text-xs font-mono font-medium cursor-pointer"
          >
            <ArrowLeft className="w-4 h-4" />
            <span>BACK TO FEATURED DECK</span>
          </button>

          <div className="flex items-center gap-3">
            <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-neutral-900 text-xs text-neutral-400 border border-neutral-800 font-mono">
